...
Invoice _$InvoiceFromJson(Map<String, dynamic> json) {
  return Invoice(
    ...
    customFields: (json['custom_fields'] as List)
        ?.map((e) =>
            e == null ? null : CustomField.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    ...
    customerTaxIds: (json['customer_tax_ids'] as List)
        ?.map((e) => e == null
            ? null
            : CustomerTaxId.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    ...
    prePaymentCreditNotesAmount: json['pre_payment_credit_notes_amount'] as int,
    ...
    totalTaxAmounts: (json['total_tax_amounts'] as List)
        ?.map((e) =>
