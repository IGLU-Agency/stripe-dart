...
class Invoices {
  ...
  Future<Map<String, dynamic>?> finalize(String id,
      {Map<String, dynamic>? params}) {
  ...
  Future<Map<String, dynamic>?> voidInvoice(String id,
      {Map<String, dynamic>? params}) {
    return _resource.voidResource(_endpoint, id, params: params);
  }

  Future<Map<String, dynamic>?> markUncollectible(String id,
      {Map<String, dynamic>? params}) {
  ...
  Future<Map<String, dynamic>?> upcoming({Map<String, dynamic>? params}) {
    return _stripe.request(RequestMethod.get, "$_endpoint/upcoming",
        params: params);
  }

  Future<Map<String, dynamic>?> upcomingLines(String id,
      {Map<String, dynamic>? params}) {
    return _stripe.request(RequestMethod.get, "$_endpoint/upcoming/lines",
        params: params);
  }
